...
const RankingCollectionCard = (props: IProps) => {
  ...
  return (
    <div className='flex flex-row justify-end items-center w-full h-[97px] pr-[27px] bg-[#DDD7E5] mt-[10px] rounded-lg relative cursor-pointer'>
      <div className='absolute left-[-7px] sm:left-[-16px] flex items-center w-full py-[15px] my-[10px]'>
        <div className='bg-purple p-[13px] rounded-l-[10px] max-w-[24px] sm:max-w-[32px] w-full' onClick={() => handleCollectionClick(collection?.slug!)}>
        ...
        <picture><img
          ...
          className='w-[55px] sm:w-[71px] h-[60px] sm:h-[67px] mr-[10px] sm:mr-[22px] object-cover rounded'
          onClick={() => handleCollectionClick(collection?.slug!)}
        /></picture>
        <div className='flex-col w-[26.2%]' onClick={() => handleCollectionClick(collection?.slug!)}>
        ...
        <div className='flex w-[16.4%] items-center' onClick={() => handleCollectionClick(collection?.slug!)}>
        ...
        <div className='flex w-[16.8%] items-center' onClick={() => handleCollectionClick(collection?.slug!)}>
          <h2 className={`font-poppins-700 text-black text-base leading-[98.3%]`}>
